...
public class UserAPI {
    ...
    public interface Iface {
         ...
         * @param token
         */
        public void updateUserPassword(String userName, String newPassword, String token) throws org.apache.airavata.userapi.error.InvalidRequestException, org.apache.airavata.userapi.error.AuthorizationException, org.apache.airavata.userapi.error.UserAPISystemException, org.apache.thrift.TException;
    ...
    public interface AsyncIface {
        ...
        public void updateUserPassword(String userName, String newPassword, String token, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void updateUserPassword(String userName, String newPassword, String token) throws org.apache.airavata.userapi.error.InvalidRequestException, org.apache.airavata.userapi.error.AuthorizationException, org.apache.airavata.userapi.error.UserAPISystemException, org.apache.thrift.TException
        {
            send_updateUserPassword(userName, newPassword, token);
            recv_updateUserPassword();
        }

        public void send_updateUserPassword(String userName, String newPassword, String token) throws org.apache.thrift.TException
        {
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public void updateUserPassword(String userName, String newPassword, String token, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
            checkReady();
            updateUserPassword_call method_call = new updateUserPassword_call(userName, newPassword, token, resultHandler, this, ___protocolFactory, ___transport);
            this.___currentMethod = method_call;
            ___manager.call(method_call);
        }
        ...
        public static class updateUserPassword_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            private String token;
            public updateUserPassword_call(String userName, String newPassword, String token, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
                super(client, protocolFactory, transport, resultHandler, false);
                this.userName = userName;
    ...
    public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
        ...
        public static class updateUserPassword<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateUserPassword_args> {
            ...
            public updateUserPassword_result getResult(I iface, updateUserPassword_args args) throws org.apache.thrift.TException {
                updateUserPassword_result result = new updateUserPassword_result();
                try {
                    iface.updateUserPassword(args.userName, args.newPassword, args.token);
                } catch (org.apache.airavata.userapi.error.InvalidRequestException ire) {
                    result.ire = ire;
                } catch (org.apache.airavata.userapi.error.AuthorizationException are) {
                    result.are = are;
    ...
    public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
        ...
        public static class updateUserPassword<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateUserPassword_args, Void> {
            ...
            public void start(I iface, updateUserPassword_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
                iface.updateUserPassword(args.userName, args.newPassword, args.token,resultHandler);
            }
        }

...
public class UserAPIServerHandler implements UserAPI.Iface{
    ...
    @Override
    public APIPermissions authenticateUser(String userName, String password, String token) throws InvalidRequestException, AuthorizationException, UserAPISystemException, TException {
    ...
    @Override
    public APIPermissions getRolePermissions(String roleName, String token) throws InvalidRequestException, AuthorizationException, UserAPISystemException, TException {
        return null;
    }
